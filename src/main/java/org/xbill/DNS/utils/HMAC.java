...
public class HMAC {
     ...
     *            The message digest object.
     * @param blockLength
     *            The block length of the message digest.
     * @param key
     *            The secret key
     */
     ...
     * @deprecated won't work with digests using a padding length other than 64;
     *             use
     *             {@code HMAC(String digestName, int blockLength, byte [] key)}
     *             instead
     ...
     *            The signature to compare against
     * @param truncation_ok
     *            If true, the signature may be truncated; only the number of
     *            bytes in the provided signature are compared.
     * @return true if the signature matches, false otherwise
     */
