...
public class DNSSEC {
    ...
    public static class Algorithm {
        ...
        private static Mnemonic algs           = new Mnemonic(
                                                              "DNSSEC algorithm",
                                                              Mnemonic.CASE_UPPER);
    ...
    public static RRSIGRecord sign(RRset rrset, DNSKEYRecord key,
                                   PrivateKey privkey, Date inception,
    ...
    public static RRSIGRecord sign(RRset rrset, DNSKEYRecord key,
                                   PrivateKey privkey, Date inception,
                                   Date expiration, String provider)
                                                                    throws DNSSECException {
        ...
        RRSIGRecord rrsig = new RRSIGRecord(rrset.getName(), rrset.getDClass(),
                                            ...
                                            alg, rrset.getTTL(), expiration,
                                            inception, key.getFootprint(),
                                            key.getName(), null);
    ...
    static SIGRecord signMessage(Message message, SIGRecord previous,
                                 KEYRecord key, PrivateKey privkey,
    ...
    static void verifyMessage(Message message, byte[] bytes, SIGRecord sig,
                              SIGRecord previous, KEYRecord key)
                                                                throws DNSSECException {
        if (!matches(sig, key)) {
